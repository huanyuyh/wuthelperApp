...
**点击日期**  
![import](file:///android_asset/guide_img/guide_course_settings.jpg)  
  
**注意！选择的日期为开学第一天的日期（一般为周一）**
## 如何查询电费
**第一次使用应用请先点击查询按钮**  
![import](file:///android_asset/guide_img/dianfee_get.jpeg)  
**登录智慧理工大账户**
![import](file:///android_asset/guide_img/guide_course_import_login.jpg)  
**进入缴费平台登录界面。获取到建筑列表后，选择自己的位置。即可查询。**  
![import](file:///android_asset/guide_img/dianfee_return.jpg)  
...
点击底部服务按钮。  
**点击页面右上角用户按钮。**  
![import](file:///android_asset/guide_img/service_login.jpeg)  
**进入账号密码保存页面输入密码保存即可。**  
![import](file:///android_asset/guide_img/service_users.jpg)
## 如何使用小雅任务导入
点击底部工具按钮。  
**滑动页面底部点击导入小雅任务按钮**  
![import](file:///android_asset/guide_img/dianfee_get.jpeg)  
...
![import](file:///android_asset/guide_img/xiaoya_import.jpeg)
## 如何使用mooc任务导入
点击底部工具按钮，点击滑动页面底部导入mooc任务按钮。  
**进入页面后登录（登录不支持第三方跳转登录）。**  
![import](file:///android_asset/guide_img/mooc_import.jpeg)  
**登录后请使用主页的搜索按钮搜索出自己的课程。**  
![import](file:///android_asset/guide_img/mooc_import_in.jpg)  
**进入详情页面后，点击下方参加进入学习页。**  
![import](file:///android_asset/guide_img/mooc_import_do.jpeg)  
...
## app的一些隐藏功能
### app是有桌面小组件的哦
![import](file:///android_asset/guide_img/widget.png)  
**小组件会自动更新**  
### app的电费是会自动更新的  
...
![import](file:///android_asset/guide_img/app_longclick.png)
## 反馈与联系我们 
如果您有任何问题或需要帮助，请通过以下方式联系我们： 
- 问题反馈腾讯文档：[APP反馈意见](https://docs.qq.com/sheet/DR1REY0d6cFJObHN3?tab=BB08J2)
- 电子邮件：huanyuradiant@outlook.com
